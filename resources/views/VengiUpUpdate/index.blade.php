			...
			<div class="content-1">
				...
				<form  action="" autocomplete="on">
				  ...
				  <p>
					...
					<input class="field" name="dob" required="required" type="text" placeholder="DD/MM/YYYY"/>
				  </p>
                  <p>
				  ...
				  <p>
					...
					<input class="field" name="password" required="required" title="Use Atleast one capital letter, one common letter, numbers and a special character. e.g. 'Hello123!'" type="password" placeholder="mypassword"/>
				  </p>
				  <p>
					<label for="passwordsignup_confirm" class="youpasswd" data-icon="p">Please confirm your password </label>
					<input class="field" name="passwordconfirm" required="required" title="Use Atleast one capital letter, one common letter, numbers and a special character. e.g. 'Hello123!'" type="password" placeholder="mypassword"/>
				  </p>
 ...
 if (isset($_POST['submit'])) {
    ...
    $password=$_POST['password'];
     ...
     if (!preg_match("/^[a-zA-Z]+$/", $name)) {
         ...
         echo  '<script type="text/javascript">myInvalid();</script>';
